...
const float THRESHOLD = 400.0; // Seuil à 450
...
void loop() {
  ...
  // Création d'un message formaté
  String message = "Valeur du capteur MQ135 : " + String(sensorValue) + " - " + gasLevel + "\n" +
                   "Humidité : " + String(humidity) + "%\tTempérature : " + String(temperature) + "°C";
